...
@section('content')
    ...
    <main>
        <div class="head-title">
            <div class="left">
                <h1>Data Interprenter (Text)</h1>
                <ul class="flex items-center gap-6">
                    <li>
                        <a href="{{ route('data-interpreter') }}" class="hover:text-blue-500 p-2 rounded-full">Interprenter
                            Lisan</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="{{ route('data-text') }}" class="text-blue-500 p-2 rounded-full bg-gray-100">Interprenter
                            Text</a>
                    </li>
                </ul>
            </div>
                            ...
                            <tr class="text-left hover:bg-gray-100">
                                ...
                                <td class=" py-2 px-4 flex justify-center items-center gap-2">
                                    ...
                                    <form id="delete-form-{{ $data->id }}"
                                        action="{{ route('data-text.destroy', ['id' => $data->id]) }}" method="POST"
                                        style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                    ...
                                    <div id="modal-{{ $data->id }}"
                                        class="fixed inset-0 bg-gray-800 bg-opacity-75 flex z-50 items-center justify-center hidden">
                                        <div
                                            class="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all max-w-lg w-full">
                                            <div class="bg-gray-100 p-4">
                                                <h5 class="text-lg text-center font-bold">{{ $data->name }}</h5>
                                            ...
                                            <div class="p-4 text-left">
                                                ...
                                                <h2 class="mb-2"><strong>Tipe:</strong>
                                                    <p>{{ $data->type }}</p>
                                                </h2>
                                            </div>
