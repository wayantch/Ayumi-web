        ...
        <div class="form-container mx-auto mt-8 bg-white p-8 rounded shadow-md">
            <form action="{{ route('data-kelas.update', $kelas->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <select id="category_id" name="category_id" required
                        ...
                        @foreach ($categories as $category)
                            <option value="{{ $category->id }}" {{ $kelas->category_id == $category->id ? 'selected' : '' }}>
                                {{ $category->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="sub_title" name="sub_title" autocomplete="sub_title" required value="{{ $kelas->sub_title }}"
                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                    @error('sub_title')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="discount" name="discount" autocomplete="discount" placeholder="Opsional (1.200.000)" value="{{ $kelas->discount }}"
                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                    @error('discount')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="price" name="price" autocomplete="price" required placeholder="(1.000.000)" value="{{ $kelas->price }}"
                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                    @error('price')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="heading1" name="heading1" autocomplete="heading1" required value="{{ $kelas->heading1 }}"
                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                    @error('heading1')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="heading2" name="heading2" autocomplete="heading2" required  value="{{ $kelas->heading2 }}" 
                        class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                    @error('heading2')
                        <p class="text-red-500 text-xs italic">{{ $message }}</p>
                    @enderror
