...
<body class="bg-white">
    ...
    <div class="content w-7/12 mx-auto px-4">
        @yield('content')
    </div>
        ...
        <ul class="flex justify-center gap-16 font-medium">
            <li class="{{ request()->routeIs('home') ? 'active' : '' }}">
                <a href="{{ route('home') }}" class="flex flex-col items-center">
                    <i class='bx bxs-book-open text-3xl text-red-700'></i>
                    <p class="text-red-700 text-sm">Program</p>
                </a>
            </li>
            <li class="{{ request()->routeIs('toko') ? 'active' : '' }}">
                <a href="{{ route('toko') }}" class="flex flex-col items-center">
                    <i class='bx bxs-store-alt text-3xl '></i>
